...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ggplot(Month, aes(x = fct_rev(fct_infreq(wday)))) + 
  geom_bar(fill="darkgreen")+
  ggtitle("Fig. 5. Accidents day by day, 2003") + coord_flip()
```
...
- October, Friday afternoon (around 5 pm). Almost the cases is the crash between two cars, and most of it results in no injury. The primary factor that cause the collisions is Failure to yield right of the way.
...
ggplot(Mo, aes(x = fct_rev(fct_infreq(wday)))) + 
  geom_bar(fill="darkgreen")+
  ggtitle("Fig. 16. Accidents day by day, 2011") + coord_flip()
```
