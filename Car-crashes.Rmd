...
knitr::opts_chunk$set(echo = F, message = F, warning = F, fig.width = 8, fig.height = 4, out.width = "100%", cache = T)
options(digits = 3)
```
...
The frequency table below (and also the graph - Figure 1.) shows us that 2003 was the year with the most accidents: 4625 cases, when 2011 is has the lowest: 3914 cases. Now we compare the overall years with 2003. Then, we compare the overall with 2011.
...
```{r, fig.height=15, fig.width=13, echo=FALSE, message=FALSE, warning=FALSE}
