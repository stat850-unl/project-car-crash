...
- Table.2. shows us that 2003 was the year with the most accidents: 4625 cases.
...
tmp %>%
  ...
  ggtitle("Fig. 1. Accidents on overall 2003 - 2015") +
  theme_minimal()
...
p <- tmp %>%
  ...
  ggtitle("Fig. 2. Overall months of accidents from 2003 to 2015") 
ggplotly(p)
...
ggplot(Month, aes(x = Month)) + 
  ...
  ggtitle("Fig. 3. Months of accidents in 2003") +
  theme_minimal()
```
...
p <- tmp %>%
  ...
  ggtitle("Fig. 4. Overall days of accidents from 2003 to 2015")
ggplotly(p)
```
...
ggplot(Month, aes(x = wday)) + 
  ...
  ggtitle("Fig. 5. Days of accidents in 2003") 
```
...
ggplot(tmp, aes(x = `Weekend?`)) + 
  ...
  ggtitle("Fig. 6. Weekday or weekend overall from 2003 to 2015") +
  theme_minimal()

ggplot(Month, aes(x = `Weekend?`)) + 
  geom_bar(fill="steelblue")+
  ggtitle("Fig. 7. Weekday or weekend in 2003") +
  theme_minimal()
...
ggplot(tmp, aes(x = "", fill=`Injury Type`)) + 
  geom_bar()+
  ggtitle("Fig. 10. Injury types  overall from 2003 to 2015") +
  theme_minimal()+
  coord_polar("y")
```
...
ggplot(Month, aes(x = "", fill=`Injury Type`)) + 
  geom_bar()+
  ggtitle("Fig. 11. Injury types  in from 2003") +
  theme_minimal()+
  coord_polar("y")
```
...
tmp %>%
  ...
  ggplot(aes(x = Month, y = count)) + 
  geom_col() + 
  ggtitle("Fig. 12. Collision types from 2003 to 2015") +
...
tmp %>%
  ...
  ggplot(aes(x = Month, y = count)) + 
  geom_col() + 
  ggtitle("Fig. 13. Collision types in 2003") +
  facet_wrap(~`Collision Type`)
...
ggplot(tmp, aes(x = fct_rev(fct_infreq(`Primary Factor`)))) + 
  geom_bar()+
  ggtitle("Fig. 14. Primary factors for accidents from 2003 to 2015") +
...
ggplot(Month, aes(x = fct_rev(fct_infreq(`Primary Factor`)))) + 
  geom_bar()+
  ggtitle("Fig. 15. Primary factors for accidents in 2003") +
  theme_minimal()+ coord_flip()
```
