...
* Automobiles are an indispensable part of life. Thanks to them that travel, transaction, business, and even medical problems has been improving. But cars also carry risks that affect human life. People's need is higher and higher, so the number of vehicles must also increase, which entails many consequences such as traffic congestion and accidents. Every day, with hundreds of millions of car trips moving continuously, the number of casualties is not small; and the accident's cause is uncountable.
