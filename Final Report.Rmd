...
As 8121 > 6636, 696 > 561, and 597 > 509, we conclude that accidents tend to appear on weekdays rather than on the weekend. Figure 7. shows the relationship between hours and weekdays. Notice that the peak is around 5 pm, and so consistent with what we are assuming about the data: Most of the accidents happened in the evening. 
...
We then look at the fatal rate. There are four types of injuries: Fatal, incapacitating, no injury/ unknown, and non-incapacitating. In Figure 6., we see that the number of no injury/unknown is more than other categories. 
...
```{r, fig.height=20, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
