...
Figure 14. is for the data of 2011, and this data is consistent with the overall years. For both the first and the second reason (for accidents) are "Failure to yield the right of way" and "Following too closely" (Notice that we have grouped some factors). 
