...
tmp <- Crash %>%
  ...
  mutate(`Primary Factor` = str_replace(`Primary Factor`, "SOULDER DEFECTIVE", "NA"))%>%
  mutate(`Primary Factor` = str_replace(`Primary Factor`, "UTILITY WORK", "NONE (ENVIRONMENTAL)"))%>%
  mutate(`Primary Factor` = str_replace(`Primary Factor`, "VIOLATION OF LICENSE RESTRICTION", "DRIVER LICENSE"))%>%
  mutate(`Primary Factor` = str_replace(`Primary Factor`, "SEVERE CROSSWINDS", "NA"))%>%
  ...
  mutate(`Primary Factor` = str_replace(`Primary Factor`, "BRAKE FAILURE OR DEFECTIVE", "OTHER (VEHICLE) - EXPLAIN IN NARRATIVE"))%>%
